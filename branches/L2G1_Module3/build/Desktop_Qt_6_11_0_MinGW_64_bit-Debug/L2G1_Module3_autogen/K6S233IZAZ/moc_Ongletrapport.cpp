...
template <> constexpr inline auto OngletRapport::qt_create_metaobjectdata<qt_meta_tag_ZN13OngletRapportE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(const FiltreGUI &)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 7, 8 },
        }}),
        // Slot 'eventFilter'
        QtMocHelpers::SlotData<bool(QObject *, QEvent *)>(9, 2, QMC::AccessPublic, QMetaType::Bool, {{
...
void OngletRapport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->exporterPDF(); break;
        case 3: _t->toggleFiltres(); break;
        case 4: _t->appliquerFiltre((*reinterpret_cast<std::add_pointer_t<FiltreGUI>>(_a[1]))); break;
